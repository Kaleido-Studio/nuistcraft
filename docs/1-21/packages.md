...
【群文件】里有最新 1.21.8 的服务器整合包，你可以在群文件里（`群文件整合包 -> Minecraft 1.21.7z`）下载。[加入我们的 QQ 群组](https://jq.qq.com/?_wv=1027&k=5EgjjUQV)

如果你缺少 Java 运行时，群文件夹 `Java 环境` 下有安装包。请注意，现在服务器版本是 1.21.8，你要装 jdk21 或者 jdk25 的版本。
...
- 现在服务器运行在 1.21.8 版本上，目前没有对更低版本做兼容。
